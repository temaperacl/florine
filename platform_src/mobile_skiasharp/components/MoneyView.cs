...
namespace FlorineSkiaSharpForms
{
    class MoneyView
    {
        ...
        public static View RenderView(int Amount, bool Background = true)
        {
            ...
            ImageText MoneyText = new ImageText("x " + Amount.ToString())
            {
        ...
        private static void MoneyRing_PaintSurface(object sender, SKPaintSurfaceEventArgs e)
        {
            ...
            e.Surface.Canvas.DrawCircle(midPoint, Rad, new SKPaint() { Color = SKColors.Black });
            e.Surface.Canvas.DrawCircle(midPoint, Rad - 2f, new SKPaint() { Color = SKColors.Gold });
